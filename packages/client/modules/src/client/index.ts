...
export function apply(ctx: Context): void {
  const modules = (globalThis as DshWindow).__MAKO_MODULES__
  ...
  if (modules === undefined) {
    throw new Error('client-modules: window.__MAKO_MODULES__ missing — the shell kernel must construct the module system before plugin boot')
  }
