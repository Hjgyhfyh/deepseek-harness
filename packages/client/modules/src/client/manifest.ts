 ...
 * `__MAKO_BOOT__` wire types, the boot-manifest parser, and the boundaries around
...
export function parseBootManifest(wire: unknown): BootManifest {
  if (typeof wire !== 'object' || wire === null) {
    throw new Error('client-modules: window.__MAKO_BOOT__ is missing or not an object')
  }
...
export interface DshWindow {
  ...
  __MAKO_BOOT__?: unknown
  /** Pre-rename host compatibility alias for {@link __MAKO_BOOT__}; read as fallback by the shell kernel. */
   ...
   */
  __MAKO_MODULES__?: ClientModuleSystem
}
