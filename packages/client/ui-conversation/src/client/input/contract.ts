...
export interface InputActions {
  ...
  submit(): void
  /**
   * Enter submission with immediate delivery: the draft steers into the
   * running turn instead of queueing behind it. The composer's busy-state
   * "send now" control rides this; best-effort like every direct steer — a
   * closed window degrades to the next waking Queue turn.
   */
  submitNow(): void
}
