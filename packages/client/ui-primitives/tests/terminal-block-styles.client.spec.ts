/**
 * TerminalBlock expand keyboard chrome: hover color also shows on focus.
 */
import { readFileSync } from 'node:fs'
import { fileURLToPath } from 'node:url'
import { describe, expect, it } from 'vitest'

const css = readFileSync(fileURLToPath(new URL('../src/TerminalBlock.module.css', import.meta.url)), 'utf8')
...
describe('TerminalBlock expand keyboard chrome', () => {
