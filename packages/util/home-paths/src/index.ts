/**
 * Shared filesystem path helpers for Mako Harness user data.
 *
...
/** Directory name for the default Mako Harness home under the OS home. */
export const DSH_HOME_DIR_NAME = '.dsh'

/** Stable user-facing display form for the default Mako Harness home. */
export const DEFAULT_DSH_HOME_DISPLAY = `~/${DSH_HOME_DIR_NAME}`

/** Environment variable that overrides the default Mako Harness home. */
...
/**
 * Resolve the default Mako Harness home using Node's platform path rules.
...
/**
 * Resolve the single-root Mako Harness home.
 *
...
/**
 * Join path segments onto the resolved Mako Harness home.
