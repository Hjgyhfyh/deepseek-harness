...
| [mail.md](mail.md) | the mailbox access seam: `MailListRequest`/`Result`, `MailReadRequest`/`Result`, provider availability and selection, `MailError` |
