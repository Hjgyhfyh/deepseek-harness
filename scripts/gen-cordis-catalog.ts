...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  MailListProvider: 'mail.md',
  MailListRequest: 'mail.md',
  MailListResult: 'mail.md',
  MailMessageSummary: 'mail.md',
  MailReadProvider: 'mail.md',
  MailReadRequest: 'mail.md',
  MailReadResult: 'mail.md',
