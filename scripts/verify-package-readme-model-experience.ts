...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-botforge': { kind: 'indirect', reason: 'The settings page and dock write host employee settings; dsh-botforge owns the model-visible prompt section and delegate_employee tool.' },
  ...
  'packages/mail/mail': { kind: 'indirect', reason: 'The provider registry delegates model rendering to dsh-tool-mail.' },
  'packages/mail/mail-imap': { kind: 'indirect', reason: 'The provider backend delegates model rendering to dsh-tool-mail.' },
